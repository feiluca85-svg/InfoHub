...
const WP8_INSTALLED_APPS = [
  ...
  { name: 'FamTito (Famiglia & To-Do)', action: './famiglia/', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="1.8" fill="none"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" stroke="#0078d7"></path><circle cx="9" cy="7" r="4" stroke="#0078d7"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87" stroke="#107c41"></path><path d="M16 3.13a4 4 0 0 1 0 7.75" stroke="#107c41"></path><polyline points="9 11 12 14 22 4" stroke="#f7630c"></polyline></svg>` },
  { name: 'FocusQuest (Todo & Focus)', action: './focus/', iconSvg: `<svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="1.8" fill="none"><circle cx="12" cy="12" r="9" stroke="#10b981"></circle><polyline points="12 6 12 12 16 14" stroke="#10b981"></polyline><path d="M8 3l8 18" stroke="#f59e0b" stroke-width="1.5"></path></svg>` },
...
function handleAppAction(action) {
  ...
  } else if (action.startsWith('./') || action.startsWith('/') || action.endsWith('/')) {
